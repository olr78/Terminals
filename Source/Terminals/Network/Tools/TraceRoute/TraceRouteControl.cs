...
namespace Terminals.Network
{
    internal partial class TraceRouteControl : UserControl
    {
        ...
        private void InitializeGraph()
        {
            ...
            myPane.Title.Text = Translator.T("Trace Route results");
        ...
        private void UpdateGraph()
        {
            ...
            myPane.Title.Text = Translator.Format("Trace Route results for {0}", this.TextHost.Text);
        ...
        private void MyContextMenuBuilder(ZedGraphControl control, ContextMenuStrip menuStrip, Point mousePt, ZedGraphControl.ContextMenuObjectState objState)
        {
            ...
            //item.Name = "add-beta";
            //item.Tag = "add-beta";
            //item.Text = Translator.T("Add a new Beta Point");
